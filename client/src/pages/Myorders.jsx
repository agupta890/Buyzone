          ...
          <div className="space-y-4">
            {items.map((item, idx) => {
              ...
              return (
                <div
                  key={idx}
                  className="flex flex-col items-center sm:flex-row sm:items-center gap-3 sm:gap-4 border border-green-500 rounded-lg p-3 hover:bg-gray-50"
                >
                  {/* Product Image */}
                  <img
                    src={product.image || "/placeholder.png"}
                    alt={product.name || "Product"}
                    className="w-20 sm:w-20 h-20 sm:h-20 object-cover rounded-lg border"
                  />
